    ...
    <div className="flex-center min-h-screen" style={{ marginTop: '-80px' }}>
      <div className="glass-card" style={{ width: '400px' }}>
        <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ fontSize: '2.2rem', margin: 0, fontWeight: '700', background: 'linear-gradient(135deg, #a5b4fc, #ec4899)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Welcome Back</h2>
        </div>
